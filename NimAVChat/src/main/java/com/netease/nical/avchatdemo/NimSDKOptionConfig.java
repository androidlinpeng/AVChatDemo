...
//import com.netease.nical.avchatdemo.main.activity.WelcomeActivity;
...
//        // 定制通知栏提醒文案（可选，如果不定制将采用SDK默认文案）
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationColor = DemoCache.getContext().getResources().getColor(R.color.color_gray_d9d9d9);
        // 通知铃声的uri字符串
