package com.netease.nical.avchatdemo.common.util.media;
...
import com.netease.nical.avchatdemo.common.util.file.AttachmentStore;
import com.netease.nical.avchatdemo.common.util.file.FileUtil;
...
public class ImageUtil {
    ...
    public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(NimUIKit.getContext().getResources(), R.drawable.avchat_close_video_send);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
